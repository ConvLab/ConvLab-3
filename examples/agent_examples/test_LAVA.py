...
def test_end2end(args, model_dir):
    ...
    user_nlu = BERTNLU("sys", config_file="multiwoz21_sys_context3.json", model_file="bertnlu_unified_multiwoz21_sys_context3")
    # user_nlu = BERTNLU_woz(mode='sys', config_file='multiwoz_sys_context.json',
