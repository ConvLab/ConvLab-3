...
from convlab2.policy.vtrace_rnn_action_embedding.train import evaluate
...
memory_path = "convlab2/policy/best_policies/AMT_memory_for_prefilling.pkl"
...
model_path = "convlab2/policy/best_policies/RNN_supervised"
